...
namespace TLVanced
{
    public class Utils
    {
        ...
        public static readonly string GameValueIniPath = Path.Combine(
            Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData),
            "TL", "Saved", "Config", "WindowsNoEditor", "GameValue.ini");

        public static readonly string InputIniPath = Path.Combine(
            Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData),
            "TL", "Saved", "Config", "WindowsNoEditor", "Input.ini");
